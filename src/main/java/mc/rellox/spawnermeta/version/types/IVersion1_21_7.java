...
public class IVersion1_21_7 implements IVersion {
	...
	public Object spawn(Object entity) {
		...
		double x = RF.direct(entity, "dP", double.class);
		RF.access(m, "e", double.class).set(x);
		double y = RF.direct(entity, "dR", double.class);
		RF.access(m, "f", double.class).set(y);
		double z = RF.direct(entity, "dV", double.class);
